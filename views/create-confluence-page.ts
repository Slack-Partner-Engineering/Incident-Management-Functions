...
const getConfluenceCreateHTML = (incident: Incident, env: any) => {
  ...
  const salesforceLink = getObjectURL(incident.salesforce_incident_id, env);
...
<table data-layout="default" ac:local-id="d6b662b4-7710-4cfd-b17c-c82e8a569447">
  ...
  <tbody>
    ...
    <tr>
      <td data-highlight-colour="#f4f5f7">
        <p><strong>Salesforce Incident</strong></p>
      </td>
      <td>
      <p><a href="${salesforceLink}">Salesforce Incident Record</a></p>
      </td>
    </tr>
  </tbody>
</table>
